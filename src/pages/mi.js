      ...
      <div className="px-[20px] md:px-[60px] pt-[10px] pb-16 flex flex-col items-center">
        <article className="bg-white/90 shadow-xl rounded-2xl max-w-3xl mx-auto p-8 border border-[#e5ffe5]">
          <h2 className="text-[#35732F] text-2xl md:text-3xl font-semibold mb-4 text-center">
            Tentang MI Riadhul Ulum
          </h2>
          <p className="text-gray-700 text-base md:text-lg leading-relaxed font-light mb-6 text-justify">
            <span className="font-semibold text-[#1F581A]">MI Riadhul Ulum</span> merupakan sebuah Madrasah Ibtidaiyah swasta yang berdiri sejak tahun <span className="font-semibold">2010</span> di bawah naungan Yayasan Riadhul Ulum Ampenan. Sejak awal berdirinya, madrasah ini berkomitmen untuk memberikan pendidikan dasar yang berkualitas, berlandaskan nilai-nilai keislaman serta pengembangan karakter peserta didik.
          </p>
          <p className="text-gray-700 text-base md:text-lg leading-relaxed font-light mb-6 text-justify">
            Dengan jumlah siswa di setiap kelas berkisar <span className="font-semibold">15 orang</span>, MI Riadhul Ulum mampu memberikan perhatian dan pendampingan yang lebih intensif, sehingga proses belajar mengajar berjalan lebih efektif dan kondusif. Madrasah ini melayani jenjang pendidikan dari kelas 1 hingga kelas 6.
          </p>
          <p className="text-gray-700 text-base md:text-lg leading-relaxed font-light text-justify">
            Tenaga pendidik di MI Riadhul Ulum terdiri dari <span className="font-semibold">9 orang guru</span> dan <span className="font-semibold">2 tenaga kependidikan</span> yang memiliki latar belakang pendidikan yang relevan serta kompetensi yang mumpuni di bidangnya. Mereka adalah individu-individu terlatih, berdedikasi, dan memiliki semangat tinggi dalam mencetak generasi yang cerdas, berakhlak mulia, dan berdaya saing.
          </p>
        </article>
      </div>
