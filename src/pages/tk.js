        ...
        <article className="bg-white/90 shadow-xl rounded-2xl max-w-3xl mx-auto p-8 border border-[#e5ffe5]">
          ...
          <p className="text-gray-700 text-base md:text-lg leading-relaxed font-light mb-6 text-justify">
            <span className="font-semibold text-[#1F581A]">
              TK Bulan Tsabit Riadhul Ulum
            </span>{" "}
            merupakan sebuah Taman Kanak-Kanak swasta yang berdiri di bawah
            naungan{" "}
          ...
          <p className="text-gray-700 text-base md:text-lg leading-relaxed font-light mb-6 text-justify">
            ...
            <span className="font-semibold">15 - 20 orang</span> di setiap tahun
            ajarannya, TK Bulan Tsabit Riadhul Ulum mampu memberikan perhatian
            dan pendampingan yang lebih intensif, sehingga proses belajar
            mengajar berjalan lebih efektif dan kondusif.
          </p>
          <p className="text-gray-700 text-base md:text-lg leading-relaxed font-light text-justify">
            Tenaga pendidik di TK Bulan Tsabit Riadhul Ulum terdiri dari{" "}
            <span className="font-semibold">1 orang guru</span>,{" "}
            <span className="font-semibold">2 tenaga kependidikan</span> dan{" "}
            <span className="font-semibold">1 kepala sekolah</span> yang
