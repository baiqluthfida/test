      ...
      <section className="bg-gradient-to-r from-[#e5ffe5] via-[#D9D9D9] to-[#f2f2f2] w-full py-12 flex items-center justify-center shadow-inner">
        <div className="text-center">
          ...
          <p className="text-[#377c3b] text-lg mt-3 font-light italic max-w-2xl mx-auto">
            Permulaan, perjalanan, dan dedikasi Yayasan Riadhul Ulum untuk
      ...
      <div className="px-[16px] md:px-[60px] pt-[30px] pb-16 flex flex-col items-center">
        <article className="bg-[#f8fff8] shadow-md rounded-2xl max-w-3xl mx-auto p-8 border border-[#e5ffe5]">
          ...
          <p className="text-gray-800 text-base md:text-lg leading-relaxed font-light mb-6 text-justify">
            ...
            didirikan dengan tujuan utama untuk memberikan pendidikan dan
            pembinaan kepada masyarakat, khususnya dalam bidang keagamaan dan
            sosial. Sejak awal berdirinya, yayasan ini berkomitmen untuk
            mencetak generasi yang{" "}
            <span className="font-semibold">berakhlak mulia</span>, memiliki
            wawasan luas, serta mampu berkontribusi dalam kehidupan
            bermasyarakat.
          </p>
          ...
          <p className="text-gray-800 text-base md:text-lg leading-relaxed font-light text-justify">
            Yayasan Riadhul Ulum didirikan oleh{" "}
            <span className="font-semibold">
              Tuan Doktorandus Haji Lukman Al Hakim
            </span>
            , seorang Pembantu Dekan III Institut Agama Islam Negeri Sunan Ampel
            Mataram, dan{" "}
            <span className="font-semibold">Tuan Lalu Istana Taufiq</span>,
            seorang Pegawai Negeri. Yayasan ini bermula dari semangat untuk
            memajukan pendidikan dan kesejahteraan sosial, dengan mendirikan
            sebuah badan hukum berbentuk yayasan (Stichting) berdasarkan{" "}
            <span className="font-semibold">
              Undang-Undang Republik Indonesia Nomor 16 Tahun 2001
            </span>{" "}
            tentang Yayasan junto Undang-Undang Nomor 28 Tahun 2004 tentang
            ...
            (satu miliar tiga ratus delapan puluh juta rupiah) berupa tanah dan
            bangunan, yayasan ini mulai beroperasi dan memberikan manfaat kepada
            masyarakat luas.
          </p>
        </article>
      </div>
