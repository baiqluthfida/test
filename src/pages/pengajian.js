      ...
      <div className="px-4 md:px-[60px] pt-[10px] pb-16 flex flex-col items-center">
        <article className="bg-[#f8fff8] shadow-md rounded-2xl max-w-3xl mx-auto p-8 border border-[#e5ffe5]">
          ...
          <p className="text-gray-800 text-base md:text-lg leading-relaxed font-light mb-6 text-justify">
            ...
            adalah kegiatan rutin Yayasan Riadhul Ulum yang dilaksanakan{" "}
            <span className="font-semibold">setiap hari Jumat</span> di mushola
            yayasan. Kegiatan ini menjadi wadah untuk memperdalam ilmu agama,
            mempererat silaturahmi, dan menumbuhkan semangat ukhuwah Islamiyah
            di antara jamaah.
            <br />
            <br />
            Pengajian dipandu oleh{" "}
            <span className="font-semibold">imam dan guru pengajian</span> yang
            telah ditentukan setiap minggunya. Setiap pertemuan berfokus pada
            kajian keislaman, tafsir, fiqh, tazkiyatun nafs, serta ceramah
            motivasi islami. Melalui kegiatan ini diharapkan para jamaah dapat
          ...
          <ul className="list-disc list-inside text-gray-700 text-base md:text-lg leading-relaxed">
            <li>minggu ke-1: Ustadz Ahmad Fauzi</li>
            <li>minggu ke-2: Ustadz H. Mahmud</li>
            <li>minggu ke-3: Ustadzah Siti Aisyah</li>
            <li>minggu ke-4: Ustadz Fadli Rahman</li>
            <li>minggu ke-5: Ustadz H. Abdullah</li>
            <li>minggu ke-6: Ustadzah Nurul Hidayah</li>
          </ul>
        </article>
      </div>
